...
<div class="md:pl-64 w-full h-auto bg-biru-800 px-4 py-2 shadow-md fixed top-0 z-10">
    <div class="flex items-center justify-between max-w-screen-xl mx-auto gap-x-3 flex-wrap md:flex-nowrap">
        ...
        <div class="ml-auto p-5 flex  cursor-pointer items-center space-x-3 flex items-center p-2 group hover:text-white <?php echo $current_page == 'Profile' ? 'active bg-biru-500 text-white' : ''; ?>"onclick="window.location.href='../Profile/index.php'">
            ...
            <div class="text-white">
                <span class="text-sm md:text-base cursor-pointer group hover:text-white text-gray-400" id="nama_lengkap"></span>
            </div>
        </div>
    </div>
</div>
