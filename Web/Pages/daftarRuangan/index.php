...
<body class="bg-gray-100">
    ...
    <div class="bg-white rounded-lg shadow-lg max-w-6xl w-full mx-4 p-6 relative" onclick="event.stopPropagation()">
        <!-- Tombol Close -->
        ...
        <div class="flex space-x-6">
            ...
            <div class="w-1/3 flex flex-col justify-between">
                ...
                <a id="pinjamButton" href="../peminjaman/" class="mt-4 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 btn-pinjam">
    Pinjam
</a>
        ...
        if (result.status === "success") {
            ...
            searchedRooms.forEach(room => {
                const {
                    ...
                    kapasitas,
                    foto_ruangan,
                    nama_fasilitas // Fasilitas dalam string
                } = room;
                ...
                const fasilitasList = fasilitasArray.map(f => `<li>${f}</li>`).join('');
                ...
                const roomCard = `
                    <div class="flex max-w-[700px] bg-white border rounded-lg shadow">
                        ...
                        <div class="p-5 flex-1">
                            ...
                            <ul class="text-gray-500 mt-2 list-disc list-inside">
                                ${fasilitasList}
                            </ul>
    ...
    // Tutup modal jika klik terjadi pada elemen overlay
...
async function loadRoomData(id_ruangan) {
    try {
        ...
        if (result.status === "success") {
            ...
            // Set up the "Pinjam" button with only id_ruangan in the URL
            const pinjamButton = document.querySelector("#modal .btn-pinjam");
            pinjamButton.href = `../peminjaman/index.php?id_ruangan=${id_ruangan}`;
        }
    } catch (error) {
