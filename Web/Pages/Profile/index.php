        ...
        <div class="container p-8 m-10 ml-60 mt-8 max-w-6xl">
            ...
            <div class="bg-white ml-20 rounded-lg py-2">
                ...
                <div class="flex items-center m-10 space-x-6 border-b">
                    <div class="w-24 h-24 bg-gray-300 rounded-full flex items-center justify-center-mt-12 ml-5">
                        <!-- Avatar Icon -->
                    ...
                    <div class="w-full p-6 flex justify-between = -mt-8">
                        <div>
                            <p class="text-3xl font-bold" id="namaLengkap">PENGGUNA SIPINJAM</p>
                            <p class="text-base text-gray-500" id="email">sipinmataku@gmail.com</p>
