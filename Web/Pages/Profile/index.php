...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="container p-8 m-10 ml-60 mt-8 max-w-6xl">
            <!-- Header -->
             <div class ="bg-white ml-44 rounded-lg py-2  " >
            <div class="bg-blue-500 rounded-t-lg p-8 m-10 h-48 flex">
                <h1 class="text-white font-bold top-4 left-4 text-2xl">PROFILE</h1>
            </div>

            <!-- Profile Section -->
            <div class="flex items-center m-10  space-x-6 border-b -">
                <div class="w-24 h-24 bg-gray-300 rounded-full flex items-center justify-center relative -top-24 ml-5">
                   
                    <!-- Avatar Icon -->
                    <svg class="w-18 h-18 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="w-full p-6 flex justify-between relative -top-16 ">
                    <div>
                        <p class="text-3xl font-bold">PENGGUNA SIPINJAM</p>
